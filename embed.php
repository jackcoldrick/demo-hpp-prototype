...
<html lang="en">
    <head>
        ...
        <title>Embed | HPP Demo Prototype</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav pre-post">
                    ...
                    <ul class="nav navbar-nav after-post">
                        <li>
                            <a href="" id='style-1'>
                                <form action="https://hpp.sandbox.realexpayments.com/pay" target='embedhpp' method="post">
                                    <input type="hidden" name="MERCHANT_ID" value="<?php echo $merchantid; ?>">
                                    <input type="hidden" class='account-type' id='acc' name="ACCOUNT" value="embed">
                                    ...
                                    <input type="submit" class='alt-btn' id="pay-button" value="Default Theme">
                                </form>
                            </a>
                        </li>
                        <li>
                            <a href="" id='style-2'>
                                <form action="https://hpp.sandbox.realexpayments.com/pay" target='embedhpp' method="post">
                                    <input type="hidden" name="MERCHANT_ID" value="<?php echo $merchantid; ?>">
                                    <input type="hidden" class='account-type' id='acc' name="ACCOUNT" value="embedtheme1">
                                    <input type="hidden" name="ORDER_ID" value="<?php echo $orderid; ?>">
                                    <input type="hidden" name="CURRENCY" value="<?php echo $curr; ?>">
                                    <input type="hidden" name="AMOUNT" value="<?php echo $amount; ?>">
                                    <input type="hidden" name="TIMESTAMP" value="<?php echo $timestamp; ?>">
                                    ...
                                    <input type="hidden" name="PAYER_EXIST" value="0"> 
                                    <input type="hidden" name="CARD_STORAGE_ENABLE" value="1">
                                    <input type="submit" class='alt-btn' id="pay-button" value="Theme 1">
                                </form>
                            </a>
                        </li>
                        <li>
                            <a href="" id='style-3'>
                                <form action="https://hpp.sandbox.realexpayments.com/pay" target='embedhpp' method="post">
                                    <input type="hidden" name="MERCHANT_ID" value="<?php echo $merchantid; ?>">
                                    <input type="hidden"  class='account-type' id='acc' name="ACCOUNT" value="embedtheme2">
                                    <input type="hidden" name="ORDER_ID" value="<?php echo $orderid; ?>">
                                    <input type="hidden" name="CURRENCY" value="<?php echo $curr; ?>">
                                    <input type="hidden" name="AMOUNT" value="<?php echo $amount; ?>">
                                    <input type="hidden" name="TIMESTAMP" value="<?php echo $timestamp; ?>">
                                    ...
                                    <input type="hidden" name="PAYER_EXIST" value="0"> 
                                    <input type="hidden" name="CARD_STORAGE_ENABLE" value="1">
                                    <input type="submit" class='alt-btn' id="pay-button" value="Theme 2">
                                </form>
                            </a>
                        </li>
                        <li>
                            <a href="" id='style-4'>
                                <form action="https://hpp.sandbox.realexpayments.com/pay" target='embedhpp' method="post">
                                    <input type="hidden" name="MERCHANT_ID" value="<?php echo $merchantid; ?>">
                                    <input type="hidden" class='account-type' id='acc' name="ACCOUNT" value="embedtheme3">
                                    <input type="hidden" name="ORDER_ID" value="<?php echo $orderid; ?>">
                                    <input type="hidden" name="CURRENCY" value="<?php echo $curr; ?>">
                                    <input type="hidden" name="AMOUNT" value="<?php echo $amount; ?>">
                                    <input type="hidden" name="TIMESTAMP" value="<?php echo $timestamp; ?>">
                                    ...
                                    <input type="hidden" name="PAYER_EXIST" value="0"> 
                                    <input type="hidden" name="CARD_STORAGE_ENABLE" value="1">
                                    <input type="submit" class='alt-btn' id="pay-button" value="Theme 3">
                                </form>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                <div class='col-lg-6 panel panel-default'>
                    <div class='panel-heading'>Embed Instructions</div>
                ...
                <div class='col-lg-6'>
                    ...
                    <iframe height='600px' width='470px' id="embedhpp" name="embedhpp" frameBorder="0"></iframe>
                </div>
            </div>
            <!-- /.row -->
        </div>
        ...
        <script src="js/account-embed.js"></script>
        <script>
